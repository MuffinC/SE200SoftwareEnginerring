...
<header>
    ...
    <nav class="navbar">
        ...
        <ul>
            ...
            <li class="navlist"><a href="aboutUs.html">about</a></li>
            <li class="active"><a href="courses.html">course</a><i class="fa fa-angle-down"></i>
                <nav class="navcourse">
                    <ul>
...
<section class="course">
    <h1 class="page-header">FIND YOUR COURSE</h1>
    <div class="container">
