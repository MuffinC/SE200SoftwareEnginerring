...
<<<<<<< HEAD:subPages/aptitude.html
            ...
            <li><a class="navbutton active" href="aptitude.html">Aptitude Test</a></li>
...
=======
            ...
            <li class="active"><a href="aptitude.php">aptitude</a></li>
            <li class="navlist"><a href="feedback.php">feedback</a></li>
>>>>>>> 50097a485d4e76e0ce4516738864ca95e2b7c59d:subPages/aptitude.php
        </ul>
        <div class="login-msg">
...
<!-- aptitude test section start-->
<section class="apptitude">
    <h1 class="page-header">FOR APTITUDE TEST</h1>
    <button class="btn" id="show-aptitude" onClick='document.getElementById("ifr").src= "https://forms.office.com/Pages/ResponsePage.aspx?id=SJPOFSq-K0aPwOF2WpsgSqmZt_qPGKVGigkrZcFXvfJUNFZDMTcwQ1QwVDJLOEhOSkZPSUlCOTNEMy4u&embed=true"'>Start Test</button>
    <div class = "aptitude-box" id = "aptitude-box">
        <iframe class = "aptitude-test" id = "ifr" allowfullscreen webkitallowfullscreen mozallowfullscreen msallowfullscreen> </iframe>
    </div>
</section>
<!-- aptitude test section end-->
